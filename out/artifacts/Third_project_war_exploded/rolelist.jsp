...
<head>
	...
	<script>
        ...
        function formSubmit() {
            $("#myform").attr("action","deletePermission");
            $("#myform").submit();
        }
	</script>
</head>
...
<div class="page-content">
    <form class="form-inline" id="myform" action="saveRoleAndPermissions" method="post">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">权限分配列表&nbsp;&nbsp;&nbsp;
            		<button type="button" class="btn btn-primary" title="新建" data-toggle="modal" data-target="#editModal">新建权限</button>
					<button type="button" class="btn btn-primary" title="删除" onclick="formSubmit()">删除权限</button>
			</div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
						<c:forEach var="menu" items="${allPermissions}">
		                    <tr>
		                        <td>
		                        <input class="theadInp" type="checkbox" name="permissionIds" value="${menu.id}"/>
		                        ${menu.name}</td>
		                        <td class="tbody">
